...
class Entry(Thread):
    ...
    def pinInit(self, pin_home=26, pin_up=19, pin_down=13, pin_check=6):
        ...
        self._pi.set_noise_filter(pin_home, 20000, 20000)
        self._pi.set_noise_filter(pin_up, 20000, 20000)
        self._pi.set_noise_filter(pin_down, 20000, 20000)
        self._pi.set_noise_filter(pin_check, 20000, 20000)
